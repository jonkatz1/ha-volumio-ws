...
`,ct=new Set(["flac","alac","wav","aiff","ape","wv","wavpack","dsf","dff","dsd"]),dt=new Set(["mp3","ogg","aac","opus","vorbis","wma","m4a"]),ut=new Set(["qobuz","tidal","spotify","spop","pandora","youtube","youtube2","webradio","mpd","upnp","airplay","snapcast","bluetooth"]);function pt({trackType:t,samplerate:e,bitdepth:i,bitrate:a,isStream:o}){const s=(r=t)?String(r).trim().toLowerCase().replace(/\s+/g,""):"";var r;const n=function(t){if(null==t)return null;if("number"==typeof t)return t;const e=String(t).trim().toLowerCase().match(/([\d.]+)/);if(!e)return null;const i=parseFloat(e[1]);return i>1e3?i/1e3:i}(e),l=function(t){if(null==t)return null;if("number"==typeof t)return t;const e=String(t).trim().match(/(\d+)/);return e?parseInt(e[1],10):null}(i),c=function(t){if(null==t)return null;if("number"==typeof t)return t;const e=String(t).trim().match(/([\d.]+)/);return e?parseFloat(e[1]):null}(a),d=ut.has(s)?"":s,u=ct.has(d),p=dt.has(d);if(o){return ht("stream",d?`${d.toUpperCase()}${c?` ${Math.round(c)}`:""}`:"STREAM","STREAM","var(--volumio-quality-stream)","var(--volumio-quality-stream-bg, rgba(66, 165, 245, 0.12))")}if(u&&(null!=l&&l>16||null!=n&&n>44.1))return ht("hires",yt(d,l,n),"HI-RES","var(--volumio-quality-hires)","var(--volumio-quality-hires-bg, rgba(212, 160, 23, 0.12))");if(u)return ht("lossless",yt(d,l,n),"LOSSLESS","var(--volumio-quality-lossless)","var(--volumio-quality-lossless-bg, rgba(0, 172, 193, 0.12))");if(!p&&(null!=l||null!=n)){if(null!=l&&l>16||null!=n&&n>44.1){return ht("hires",yt(d||"HI-RES",l,n),"HI-RES","var(--volumio-quality-hires)","var(--volumio-quality-hires-bg, rgba(212, 160, 23, 0.12))")}return ht("lossless",yt(d||"LOSSLESS",l,n),"LOSSLESS","var(--volumio-quality-lossless)","var(--volumio-quality-lossless-bg, rgba(0, 172, 193, 0.12))")}if(p){if(null!=c&&c<256)return ht("basic",`${d.toUpperCase()} ${Math.round(c)}`,"BASIC","var(--volumio-quality-basic, #616161)","rgba(97, 97, 97, 0.08)");return ht("high",d?`${d.toUpperCase()}${c?` ${Math.round(c)}`:""}`:"HIGH","HIGH","var(--volumio-quality-lossy)","var(--volumio-quality-lossy-bg, rgba(158, 158, 158, 0.08))")}return d&&null!=c?c<256?ht("basic",`${Math.round(c)} kbps`,"BASIC","var(--volumio-quality-basic, #616161)","rgba(97, 97, 97, 0.08)"):ht("high",`${Math.round(c)} kbps`,"HIGH","var(--volumio-quality-lossy)","var(--volumio-quality-lossy-bg, rgba(158, 158, 158, 0.08))"):ht("unknown","","","var(--secondary-text-color)","transparent")}function ht(t,e,i,a,o){return{tier:t,label:e,tierLabel:i,color:a,colorBg:o}}const mt=new Set(["qobuz","tidal"]),vt=new Set(["spotify","spop","youtube","youtube2","ytmusic"]),bt=new Set(["webradio","pandora"]);function gt(t){const e=t.trackType||t.tracktype,i=e?String(e).trim().toLowerCase():"",a=ut.has(i);if(null!=t.samplerate||null!=t.bitdepth||null!=t.bitrate||e&&!a)return pt({trackType:e,samplerate:t.samplerate,bitdepth:t.bitdepth,bitrate:t.bitrate,isStream:!1});const o=(t.uri||"").toLowerCase(),s=(t.service||(a?i:"")).toLowerCase();let r="";const n=o.match(/\.([a-z0-9]+)(?:[?#]|$)/);if(n){const t=n[1];["flac","alac","wav","aiff","aif","ape","wv","dsf","dff","dsd"].includes(t)||["mp3","ogg","opus","aac","wma"].includes(t)?r=t:"m4a"===t&&(r="aac")}return r||(mt.has(s)?r="flac":vt.has(s)&&(r="ogg")),pt({trackType:r,samplerate:null,bitdepth:null,bitrate:null,isStream:bt.has(s)})}function yt(t,e,i){const a=t.toUpperCase();return e&&i?`${a} ${e}/${i}`:e?`${a} ${e}-bit`:i?`${a} ${i}kHz`:a}function xt(t){if(!t||t<=0)return"0:00";const e=Math.floor(t),i=Math.floor(e/3600),a=Math.floor(e%3600/60),o=e%60;return i>0?`${i}:${a.toString().padStart(2,"0")}:${o.toString().padStart(2,"0")}`:`${a}:${o.toString().padStart(2,"0")}`}function _t(t,e){return t?/^[a-z][a-z0-9+.-]*:/i.test(t)?/^https?:\/\//i.test(t)?t:"":/^\/api\//.test(t)?t:e&&!/^https?:\/\//i.test(e)?"":e?`${e}${t}`:t:""}class ft{constructor(){this._hass=null,this._panel=null,this._entityId=null,this._configEntryId=null,this._sensorBase=null,this._queueUnsub=null,this._lastState=null,this._stateListeners=new Set,this._queueListeners=new Set}connect({hass:t,panel:e}){this._hass=t,this._panel=e,this._resolveIds(),this._subscribeQueue()}updateHass(t,e){this._hass=t,void 0!==e&&(this._panel=e),this._resolveIds();const i=this._normalize();if(function(t,e){if(!t||!e)return!0;const i=Object.keys(e).filter(t=>"_raw"!==t);return i.some(i=>t[i]!==e[i])}(this._lastState,i)){this._lastState=i;for(const t of this._stateListeners)try{t(i)}catch(t){console.error("[ha-adapter] State listener error:",t)}}}disconnect(){this._unsubscribeQueue(),this._stateListeners.clear(),this._queueListeners.clear()}getState(){return this._normalize()}getVolumioUrl(){return this._panel?.config?.volumio_url||""}getSensorValue(t){return this.getState()[t]||null}get ready(){return!(!this._entityId||!this._configEntryId)}get entityId(){return this._entityId}async call(t,e={}){if(!this._hass||!this._configEntryId)throw new Error(`Adapter not ready: call(${t})`);return await this._hass.connection.sendMessagePromise({type:"call_service",domain:"volumio_ws",service:t,service_data:{config_entry_id:this._configEntryId,...e},return_response:!0})}async play(){await this._mediaPlayerCall("media_play")}async pause(){await this._mediaPlayerCall("media_pause")}async playPause(){"playing"===this.getState().state?await this.pause():await this.play()}async stop(){await this._mediaPlayerCall("media_stop")}async next(){await this._mediaPlayerCall("media_next_track")}async prev(){await this._mediaPlayerCall("media_previous_track")}async seek(t){await this._mediaPlayerCall("media_seek",{seek_position:t})}async setVolume(t){this.getState().volumeEnabled&&await this._mediaPlayerCall("set_volume_level",{volume_level:t/100})}async mute(t){this.getState().volumeEnabled&&await this._mediaPlayerCall("volume_mute",{is_volume_muted:t})}async toggleMute(){const t=this.getState();await this.mute(!t.muted)}async setShuffle(t){await this._mediaPlayerCall("shuffle_set",{shuffle:t})}async setRepeat(t){await this._mediaPlayerCall("repeat_set",{repeat:t})}onQueueChange(t){this._queueListeners.add(t)}offQueueChange(t){this._queueListeners.delete(t)}onStateChange(t){this._stateListeners.add(t)}offStateChange(t){this._stateListeners.delete(t)}_normalize(){return function(t,e,i){if(!t)return{state:"unavailable",title:"",artist:"",album:"",albumArt:"",duration:0,position:0,positionUpdatedAt:"",volume:0,muted:!1,shuffle:!1,repeat:"off",source:"",uri:"",queuePosition:-1,volumeEnabled:!1,bitrate:null,_raw:{}};const a=t.attributes||{},o=a.supported_features||0,s={};if(e&&i){const t={trackType:"track_type",samplerate:"sample_rate",bitdepth:"bit_depth",channels:"channels"};for(const[a,o]of Object.entries(t)){const t=`sensor.${e}_${o}`,r=i.states?.[t];s[a]="unknown"!==r?.state&&"unavailable"!==r?.state?r.state:null}}return{state:t.state||"unavailable",title:a.media_title||"",artist:a.media_artist||"",album:a.media_album_name||"",albumArt:a.entity_picture||"",duration:a.media_duration||0,position:a.media_position||0,positionUpdatedAt:a.media_position_updated_at||"",volume:null!=a.volume_level?Math.round(100*a.volume_level):0,muted:a.is_volume_muted||!1,shuffle:a.shuffle||!1,repeat:a.repeat||"off",source:a.source||"",uri:a.uri||"",queuePosition:a.queue_position??-1,volumeEnabled:!!(4&o),bitrate:a.bitrate||null,trackType:s.trackType||null,samplerate:s.samplerate||null,bitdepth:s.bitdepth||null,channels:s.channels||null,_raw:a}}(this._entityId?this._hass?.states?.[this._entityId]:null,this._sensorBase,this._hass)}_resolveIds(){if(!this._entityId||!this._configEntryId){if(!this._entityId&&this._hass){let t=Object.keys(this._hass.states).find(t=>t.startsWith("media_player.")&&!0===this._hass.states[t].attributes?.volumio_ws);t||(t=Object.keys(this._hass.states).find(t=>t.startsWith("media_player.")&&t.includes("volumio"))),t&&(this._entityId=t,this._sensorBase=t.replace("media_player.",""))}!this._configEntryId&&this._panel?.config?.config_entry_id&&(this._configEntryId=this._panel.config.config_entry_id)}}async _subscribeQueue(){if(!this._queueUnsub&&this._hass){try{this._queueUnsub=await this._hass.connection.subscribeMessage(t=>{if(t.queue){const e=[...t.queue];this._notifyQueue(e)}},{type:"volumio_ws/subscribe_queue"})}catch(t){console.warn("[ha-adapter] Queue subscription failed:",t)}if(this._configEntryId)try{const t=await this.call("queue_get");t?.response?.queue&&this._notifyQueue([...t.response.queue])}catch{}}}_unsubscribeQueue(){this._queueUnsub&&("function"==typeof this._queueUnsub&&this._queueUnsub(),this._queueUnsub=null)}_notifyQueue(t){for(const e of this._queueListeners)try{e(t)}catch(t){console.error("[ha-adapter] Queue listener error:",t)}}async _mediaPlayerCall(t,e={}){if(!this._hass||!this._entityId)throw new Error(`Adapter not ready: media_player.${t}`);return await this._hass.callService("media_player",t,{entity_id:this._entityId,...e})}}const wt=[{key:"now-playing",label:"Now Playing"},{key:"browse",label:"Browse"},{key:"playlists",label:"Playlists"},{key:"favorites",label:"Favorites"}];customElements.define("volumio-top-bar",class extends rt{static get properties(){return{activeView:{type:String,attribute:"active-view"},breadcrumb:{type:Array},showBackButton:{type:Boolean,attribute:"show-back-button"},narrow:{type:Boolean},searchQuery:{type:String,attribute:"search-query"},_searchValue:{type:String,state:!0},_searchFocused:{type:Boolean,state:!0}}}static get styles(){return s`
    ...
    `}constructor(){super(),this.activeView="now-playing",this.breadcrumb=[],this.showBackButton=!1,this.narrow=!1,this.searchQuery="",this._searchValue="",this._searchFocused=!1,this._debounceTimer=null,this._recentSearches=JSON.parse(localStorage.getItem("volumio-recent-searches")||"[]")}render(){return Q`
      <div class="topbar">
        <button
          class="icon-btn"
    ...
    `}_renderBreadcrumb(){const t=this.breadcrumb,e=t.length>5?[t[0],{label:"...",path:null},...t.slice(-3)]:t;return Q`
    ...
    `}constructor(){super(),this.sources=[],this.activeSource="",this.mode="pinned",this.activeView=""}render(){const t="collapsed"===this.mode;return Q`
      <nav class="nav ${this.mode}" aria-label="Music sources">
        <div class="nav-scroll">
          ...
          ${this.sources.map(t=>{const e=$t[t.plugin_name]||$t[t.plugin_type]||"mdi:music-box",i=this.activeSource===t.uri;return Q`
              <button
    ...
    `}});const St={qobuz:"Qobuz",tidal:"TIDAL",mpd:"Local",webradio:"Radio",spotify:"Spotify",spop:"Spotify",pandora:"Pandora",youtube:"YouTube",youtube2:"YouTube"},Ct={mpd:"mdi:folder-music",webradio:"mdi:radio"};customElements.define("volumio-source-badge",class extends rt{static get properties(){return{source:{type:String}}}static get styles(){return s`
      :host {
        display: inline-flex;
        align-items: center;
      }
    ...
    `}constructor(){super(),this.source=""}render(){if(!this.source)return Q``;const t=St[this.source]||this.source,e=Ct[this.source]||null;return Q`
      <span class="source">
    ...
    `}constructor(){super(),this.playerState="idle",this.title="",this.artist="",this.albumArt="",this.duration=0,this.position=0,this.positionUpdatedAt="",this.volume=0,this.muted=!1,this.shuffle=!1,this.repeat="off",this.quality=null,this.source="",this.volumeEnabled=!0,this.isFavorite=!1,this._displayPosition=0,this._isDragging=!1,this._rafId=null}connectedCallback(){super.connectedCallback(),this._startProgressAnimation()}disconnectedCallback(){super.disconnectedCallback(),this._stopProgressAnimation()}updated(t){(t.has("position")||t.has("positionUpdatedAt")||t.has("playerState"))&&(this._isDragging||(this._displayPosition=this.position||0))}_startProgressAnimation(){const t=()=>{if("playing"===this.playerState&&!this._isDragging&&this.positionUpdatedAt){const t=new Date(this.positionUpdatedAt).getTime(),e=(Date.now()-t)/1e3,i=(this.position||0)+e;this._displayPosition=Math.min(i,this.duration||1/0)}this._rafId=requestAnimationFrame(t)};this._rafId=requestAnimationFrame(t)}_stopProgressAnimation(){this._rafId&&(cancelAnimationFrame(this._rafId),this._rafId=null)}render(){if("unavailable"===this.playerState)return Q`
      ...
      `;const t="playing"===this.playerState,e=this.duration>0?Math.min(100,this._displayPosition/this.duration*100):0,i="one"===this.repeat?"mdi:repeat-once":"mdi:repeat",a="off"!==this.repeat,o=this.muted?"mdi:volume-mute":"mdi:volume-high";return Q`
    ...
    `:Q`
      ...
      `}_renderSourceCard(t){const e=At[t.plugin_name]||At[t.plugin_type]||"mdi:music-box",i=_t(t.albumart||t.icon,this.volumioUrl);return Q`
      <div
        class="source-card"
        @click=${()=>this._selectSource(t)}
        title="${t.name}"
    ...
    `}constructor(){super(),this.items=[],this.viewMode=localStorage.getItem("volumio-browse-view")||"grid",this.loading=!1,this.currentUri="",this.volumioUrl="",this._displayCount=100}render(){if(this.loading)return this._renderSkeleton();if(!this.items||0===this.items.length)return Q`
        <div class="empty-state">
    ...
    `}updated(t){t.has("items")&&(this._displayCount=100)}_renderGrid(t){return Q`
      <div class="browse-grid">
        ${t.map(t=>{const e=_t(t.albumart,this.volumioUrl),i=this._getItemLetter(t);return Q`
            <volumio-album-card
              data-letter="${i}"
    ...
    `}_renderList(t){const e=!t.some(t=>t.duration>0);return Q`
      <div class="browse-list">
        ...
        ${t.map((t,i)=>{const a=_t(t.albumart,this.volumioUrl),o=gt(t),s=this._getItemLetter(t);return Q`
            <volumio-track-card
              data-letter="${s}"
              .index=${i+1}
              title="${t.title||t.name||""}"
    ...
    `}constructor(){super(),this.albumTitle="",this.albumArtist="",this.albumArt="",this.albumUri="",this.albumService="",this.tracks=[],this.loading=!1,this.currentUri="",this.quality=null,this.volumioUrl=""}render(){if(this.loading)return this._renderSkeleton();const t=this.tracks.length,e=this.tracks.reduce((t,e)=>t+(e.duration||0),0);return Q`
      <div class="album-header">
        <div class="album-art-container">
          ${this.albumArt?Q`<img src="${_t(this.albumArt,this.volumioUrl)}" alt="${this.albumTitle}" @error=${this._onArtError} />`:Q`<div class="album-art-placeholder">
        ...
        <div class="album-meta">
          ...
          <div class="meta-details">
            ...
            ${e>0?Q`<span class="detail">${xt(e)}</span>`:""}
            ${this.albumService?Q`
              <span class="sep">·</span>
      ...
      ${t>0?Q`
        <div class="track-list">
          ...
          ${this.tracks.map((t,e)=>{const i=_t(t.albumart||this.albumArt,this.volumioUrl),a=gt(t);return Q`
              <volumio-track-card
                .index=${e+1}
                title="${t.title||t.name||""}"
    ...
    `}constructor(){super(),this.artistName="",this.items=[],this.loading=!1,this.volumioUrl=""}render(){return this.loading?this._renderSkeleton():Q`
      ...
      <div class="section">
        ...
        ${this.items&&this.items.length>0?Q`
            <div class="albums-grid">
              ${this.items.map(t=>{const e=_t(t.albumart||t.icon,this.volumioUrl);return Q`
                  <volumio-album-card
                    title="${t.title||t.name||""}"
    ...
    `}_renderTypeSection(t,e){const i=`${e}:${t.type}`,a=!0===this._expandedSections[i],o=t.type.toLowerCase(),s=o.includes("album"),r=o.includes("track")||o.includes("song"),n=o.includes("artist");let l;l=s?4:r||n?3:4;const c=a?t.items:t.items.slice(0,l),d=t.items.length>l&&!a;return Q`
    ...
    `}_renderGridItems(t,e){return Q`
      <div class="items-grid">
        ${t.map(t=>{const i=_t(t.albumart||t.icon,this.volumioUrl);return Q`
            <volumio-album-card
              title="${t.title||t.name||""}"
              artist="${t.artist||""}"
              albumart="${i}"
    ...
    `}_renderTrackItems(t){return Q`
      <div class="items-list">
        ${t.map((t,e)=>{const i=_t(t.albumart||t.icon,this.volumioUrl);return Q`
            <volumio-track-card
              .index=${e+1}
              title="${t.title||t.name||""}"
              artist="${t.artist||""}"
      ...
      ${0===t?Q`
        ...
        `:Q`
          <div class="track-list">
            ...
            ${this.tracks.map((t,e)=>{const i=_t(t.albumart||t.icon,this.volumioUrl);return Q`
      ...
      ${0===this.items.length?Q`
        ...
        `:Q`
          <div class="favorites-list">
            ${this.items.map(t=>{const e=_t(t.albumart,this.volumioUrl),i=t.uri===this.currentUri,a=[t.artist,t.album].filter(Boolean).join(" — ");return Q`
                <div
                ...
                >
                  ...
                  <span class="fav-service">${o=t.service,o?qt[o]||o.charAt(0).toUpperCase()+o.slice(1):""}</span>
                  <button
                    class="fav-context"
                    @click=${e=>this._onDotsClick(e,t)}
                    title="More actions"
    ...
    `}constructor(){super(),this.history=[],this.currentUri="",this.volumioUrl=""}render(){if(0===this.history.length)return Q`
      ...
      ${t.map(t=>Q`
        <div class="date-group">
          ...
          ${t.items.map(t=>{const e=_t(t.albumart,this.volumioUrl),i=t.uri===this.currentUri,a=[t.artist,t.album].filter(Boolean).join(" — "),o=this._formatTime(t.timestamp);return Q`
              <div
            ...
            ${0===this._queue.length?Q`
                ...
                >
                  ...
                  ${this._settingQueueThumbnails?Q`
                    <div class="qi-art">
                      ${i.albumart?Q`<img src="${_t(i.albumart,e)}" alt="" loading="lazy" />`:Q`<ha-icon icon="mdi:music-note"></ha-icon>`}
                    </div>
                  `:""}
                  <div class="qi-info">
